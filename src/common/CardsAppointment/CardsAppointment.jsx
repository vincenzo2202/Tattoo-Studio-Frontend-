            ...
            {!collapsed
                ? (
                    <div className="card-appointment-board" >
                        ...
                        <div className="right">
                            ...
                            <div className="desc-col">Category: </div>
                        ...
                        <div className="buttons-card-appointments">
                            <LinkButton
                                ...
                                title={<div className="button-update-appointment" >
                                    <img className="upd" src="https://cdn.icon-icons.com/icons2/1558/PNG/512/353430-checkbox-edit-pen-pencil_107516.png" alt="" />
                                </div>}
                                emit={() => emit()}
                            />
                            <LinkDelete
                ...
                : (
                    <div className="date-category">
                        ...
                        <div className="date">{date}</div>
                        <div className="desc-row">Shift: </div>
                        <div className="shift">{shift}</div>
